    ...
    <section class="margin_container">
        <div class="container">
            <form enctype="multipart/form-data" id="formularioPro" action="AttPro.php" method="POST">
                ...
                <input value="<?php echo $row->descricao?>" type="text" name="descricao" class="form-control" id="descricao" required>


                <label for="preco" class="form-label">Preço</label>
                <input value="<?php echo $row->preco?>" type="number" name="preco" class="form-control" id="preco" step="0.01" required>


                <label for="imagem" class="form-label">Imagem do Produto</label>
                <img name="profilePic" id="profilePic" src="<?php echo $row->img?>" alt="imagem padão do site">
