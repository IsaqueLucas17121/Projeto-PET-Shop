...
<body>
  <header class="cabecario" id="cabecario">
        ...
        <span><i class="bi bi-droplet"></i>  Banho/Tosa</span>
        <span><i class="bi bi-house-heart"></i>  Creche</span>
        <span><a href="login.html"><i class="bi bi-person-circle"></i>  Entrar</a></span>
  </header>
    ...
    <section class="margin_container">
        <div class="container">
            <form id="formularioPro">
                ...
                <img src="https://icones.pro/wp-content/uploads/2021/06/icone-d-image-bleue.png" alt="imagem padão do site">
