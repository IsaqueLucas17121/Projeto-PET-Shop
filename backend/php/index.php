...
<body>
    ...
    <nav>
        <ul>
            ...
            <li style="display: none; <?php if($vendedor == TRUE){echo 'display: block;';}?>"><a href="produto/cadastroPro.php">Produto</a></li>
            <li style="<?php if($vendedor == TRUE){echo 'display: none;';}?>"><a onclick="MostrarSer()" style="cursor: pointer;">Serviços</a></li>
    ...
    <div class="primeira_box">
        ...
        <div class="magin_roll" id="roll2">
            ...
            <h1>AGENDE AGORA</h1>
            <a href="../../frontend/pages/AgendarPet.php"><h3>Clique Aqui</h3></a>
        </div>
